(function ($) {
    ...
    /*--
        Courses Tabs Menu
    -----------------------------------*/
    var Tariqul = new Swiper('.courses-active .swiper-container', {
        speed: 600,
        spaceBetween: 30,        
        navigation: {
    ...
    /*--
        Testimonial
    -----------------------------------*/
    var Tariqul = new Swiper('.testimonial-active .swiper-container', {
        speed: 600,
        spaceBetween: 30,        
        pagination: {
    ...
    /*--
        Brand
    -----------------------------------*/
    var Tariqul = new Swiper('.brand-active .swiper-container', {
        speed: 600,
        spaceBetween: 30,
        loop: true,
        breakpoints: {
    ...
    /*--
        Reviews
    -----------------------------------*/
    var Tariqul = new Swiper('.reviews-active .swiper-container', {
        speed: 600,
        spaceBetween: 30,
        loop: true,  
        pagination: {
    ...
    /*--
        Student's
    -----------------------------------*/
    var Tariqul = new Swiper('.students-active .swiper-container', {
        speed: 600,
        spaceBetween: 30,        
        navigation: {
